        ...
        children: [
          ...
          ElevatedButton(
              ...
              onPressed: () async {
                 Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => SingleDepartmentListScreen(department: null,),
                                ),
                            );
              },
    ...
    return Expanded(
          child: SingleChildScrollView(
            child: DataTable(
                ...
                rows: result?.result
                        .map((Department e) => DataRow(onSelectChanged: (selected)=>{
                          if(selected == true){
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => SingleDepartmentListScreen(department: e,),
                                ),
                            )
                          }
                        },cells: [
                              ...
                              DataCell(Text(e.razrednikID.toString() ?? "")),
                            ]))
                        .toList() ??
                    []),
          )
