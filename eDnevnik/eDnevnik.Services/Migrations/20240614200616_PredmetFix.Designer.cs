...
namespace eDnevnik.Services.Migrations
{
    ...
    [Migration("20240614200616_PredmetFix")]
    partial class PredmetFix
    {
            ...
            modelBuilder.Entity("eDnevnik.Services.Database.KorisniciUloge", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            KorisnikUlogaID = 1,
                            DatumIzmjene = new DateTime(2024, 6, 14, 22, 6, 15, 798, DateTimeKind.Local).AddTicks(8816),
                            KorisnikID = 1,
                            UlogaID = 1
                        },
                        new
                        {
                            KorisnikUlogaID = 2,
                            DatumIzmjene = new DateTime(2024, 6, 14, 22, 6, 15, 798, DateTimeKind.Local).AddTicks(8861),
                            KorisnikID = 2,
                            UlogaID = 2
                        },
                        new
                        {
                            KorisnikUlogaID = 3,
                            DatumIzmjene = new DateTime(2024, 6, 14, 22, 6, 15, 798, DateTimeKind.Local).AddTicks(8864),
                            KorisnikID = 3,
                            UlogaID = 2
                        });
                });
            ...
            modelBuilder.Entity("eDnevnik.Services.Database.Ocjene", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OcjenaID = 1,
                            Datum = new DateTime(2024, 6, 14, 22, 6, 15, 798, DateTimeKind.Local).AddTicks(8914),
                            Ocjena = 5,
                            PredmetID = 1,
                            ProfesorID = 1,
                            UcenikID = 2
                        ...
                        {
                            OcjenaID = 2,
                            Datum = new DateTime(2024, 6, 14, 22, 6, 15, 798, DateTimeKind.Local).AddTicks(8919),
                            Ocjena = 4,
                            PredmetID = 2,
                            ProfesorID = 1,
                            UcenikID = 2
