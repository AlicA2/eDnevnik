...
namespace eDnevnik.Services.Migrations
{
    ...
    [Migration("20240812093236_PredmetSkola")]
    partial class PredmetSkola
    {
            ...
            modelBuilder.Entity("eDnevnik.Services.Database.KorisniciUloge", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            KorisnikUlogaID = 1,
                            DatumIzmjene = new DateTime(2024, 8, 12, 11, 32, 35, 519, DateTimeKind.Local).AddTicks(3652),
                            KorisnikID = 1,
                            UlogaID = 1
                        },
                        new
                        {
                            KorisnikUlogaID = 2,
                            DatumIzmjene = new DateTime(2024, 8, 12, 11, 32, 35, 519, DateTimeKind.Local).AddTicks(3702),
                            KorisnikID = 2,
                            UlogaID = 2
                        },
                        new
                        {
                            KorisnikUlogaID = 3,
                            DatumIzmjene = new DateTime(2024, 8, 12, 11, 32, 35, 519, DateTimeKind.Local).AddTicks(3706),
                            KorisnikID = 3,
                            UlogaID = 2
                        },
                        new
                        {
                            KorisnikUlogaID = 4,
                            DatumIzmjene = new DateTime(2024, 8, 12, 11, 32, 35, 519, DateTimeKind.Local).AddTicks(3709),
                            KorisnikID = 4,
                            UlogaID = 1
                        });
                });
            ...
            modelBuilder.Entity("eDnevnik.Services.Database.Ocjene", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OcjenaID = 1,
                            Datum = new DateTime(2024, 8, 12, 11, 32, 35, 519, DateTimeKind.Local).AddTicks(3758),
                            KorisnikID = 2,
                            PredmetID = 1,
                            VrijednostOcjene = 5
                        },
                        ...
                        {
                            OcjenaID = 2,
                            Datum = new DateTime(2024, 8, 12, 11, 32, 35, 519, DateTimeKind.Local).AddTicks(3826),
                            KorisnikID = 2,
                            PredmetID = 2,
                            VrijednostOcjene = 4
                        });
