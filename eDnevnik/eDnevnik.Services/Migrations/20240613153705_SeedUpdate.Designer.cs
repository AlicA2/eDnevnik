...
namespace eDnevnik.Services.Migrations
{
    ...
    [Migration("20240613153705_SeedUpdate")]
            ...
            modelBuilder.Entity("eDnevnik.Services.Database.KorisniciUloge", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            KorisnikUlogaID = 1,
                            DatumIzmjene = new DateTime(2024, 6, 13, 17, 37, 4, 803, DateTimeKind.Local).AddTicks(8104),
                            KorisnikID = 1,
                            UlogaID = 1
                        },
                        new
                        {
                            KorisnikUlogaID = 2,
                            DatumIzmjene = new DateTime(2024, 6, 13, 17, 37, 4, 803, DateTimeKind.Local).AddTicks(8167),
                            KorisnikID = 2,
                            UlogaID = 2
                        },
                        new
                        {
                            KorisnikUlogaID = 3,
                            DatumIzmjene = new DateTime(2024, 6, 13, 17, 37, 4, 803, DateTimeKind.Local).AddTicks(8171),
                            KorisnikID = 3,
                            UlogaID = 2
                        });
                });
            ...
            modelBuilder.Entity("eDnevnik.Services.Database.Ocjene", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OcjenaID = 1,
                            Datum = new DateTime(2024, 6, 13, 17, 37, 4, 803, DateTimeKind.Local).AddTicks(8225),
                            Ocjena = 5,
                            PredmetID = 1,
                            ProfesorID = 1,
                            UcenikID = 2
                        ...
                        {
                            OcjenaID = 2,
                            Datum = new DateTime(2024, 6, 13, 17, 37, 4, 803, DateTimeKind.Local).AddTicks(8232),
                            Ocjena = 4,
                            PredmetID = 2,
                            ProfesorID = 1,
                            UcenikID = 2
