...
namespace eDnevnik.Services.Migrations
{
    ...
    [Migration("20240616105012_StateMachine01")]
    partial class StateMachine01
    {
            ...
            modelBuilder.Entity("eDnevnik.Services.Database.KorisniciUloge", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            KorisnikUlogaID = 1,
                            DatumIzmjene = new DateTime(2024, 6, 16, 12, 50, 12, 332, DateTimeKind.Local).AddTicks(5535),
                            KorisnikID = 1,
                            UlogaID = 1
                        },
                        new
                        {
                            KorisnikUlogaID = 2,
                            DatumIzmjene = new DateTime(2024, 6, 16, 12, 50, 12, 332, DateTimeKind.Local).AddTicks(5576),
                            KorisnikID = 2,
                            UlogaID = 2
                        },
                        new
                        {
                            KorisnikUlogaID = 3,
                            DatumIzmjene = new DateTime(2024, 6, 16, 12, 50, 12, 332, DateTimeKind.Local).AddTicks(5580),
                            KorisnikID = 3,
                            UlogaID = 2
                        });
                });
            ...
            modelBuilder.Entity("eDnevnik.Services.Database.Ocjene", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OcjenaID = 1,
                            Datum = new DateTime(2024, 6, 16, 12, 50, 12, 332, DateTimeKind.Local).AddTicks(5631),
                            Ocjena = 5,
                            PredmetID = 1,
                            ProfesorID = 1,
                            UcenikID = 2
                        ...
                        {
                            OcjenaID = 2,
                            Datum = new DateTime(2024, 6, 16, 12, 50, 12, 332, DateTimeKind.Local).AddTicks(5636),
                            Ocjena = 4,
                            PredmetID = 2,
                            ProfesorID = 1,
                            UcenikID = 2
